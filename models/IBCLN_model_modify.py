...
class IBCLNModel(BaseModel, torch.nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['idt_T', 'res', 'MP', 'G', 'T', 'idt_R', 'R', 'ssim']
    ...
    def set_input(self, input):
        ...
        # print("T shape:{}".format(self.real_T.shape))
        # print("I shape:{}".format(self.real_I.shape))
    ...
    def init(self):
        ...
        self.r_h = self.get_c()
        self.r_c = self.get_c()
        self.fake_T = torch.as_tensor(self.real_I)
        self.fake_Ts = [self.fake_T]
    ...
    def backward_G(self):
        ...
        self.loss_ssim = self.criterionSSIM(self.fake_T, self.real_T)

        self.loss_G = self.criterionGAN(self.netD(self.fake_T), True) * 0.01  # L_adv: adversarial loss
        self.loss_T = self.loss_idt_T + self.loss_res + self.loss_MP + self.loss_G + 0.01 * self.loss_ssim
